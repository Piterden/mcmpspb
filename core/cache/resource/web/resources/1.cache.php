...
<li>
    ...
    <div id="slider" class="owl-carousel owl-theme">
        <div class="item slide1.jpg">
    <div style="
        background: url(\'/assets/gallery/1/6.jpg\'); 
        width: 100%; 
        height: 387px;
        max-width: 1910px;
        margin: 0 auto;
...
<div class="item slide3.jpg">
    <div style="
        background: url(\'/assets/gallery/1/7.jpg\'); 
        width: 100%; 
        height: 387px;
        max-width: 1910px;
        margin: 0 auto;
...
<div class="item slide2.jpg">
    <div style="
        background: url(\'/assets/gallery/1/8.jpg\'); 
        width: 100%; 
        height: 387px;
        max-width: 1910px;
        margin: 0 auto;
...
<div class="item slide2.jpg">
    ...
    '[[$mainSlider]]' => '<div class="slider-wrap">
    <div id="slider" class="owl-carousel owl-theme">
        <div class="item slide1.jpg">
    <div style="
        background: url(\'/assets/gallery/1/6.jpg\'); 
