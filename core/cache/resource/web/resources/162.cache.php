<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<h2>Платные услуги узи</h2>

<h3>Стоимость прохождения ультразвукового исследования</h3>

<table border="1" cellpadding="10" cellspacing="0">
	<tbody>
		<tr>
			<th width="5%">Код</th>
			<th width="65%">Услуга</th>
			<th width="15%">Цена в центре</th>
			<th width="15%">Цена на дому</th>
		</tr>
		<tr>
			<td align="center">1</td>
			<td>УЗИ органов брюшной полости: печень, поджелудочная железа, желчный пузырь, селезенка</td>
			<td align="center">800,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
		<tr>
			<td align="center">2</td>
			<td>Исследование функции желчного пузыря</td>
			<td align="center">800,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
		<tr>
			<td align="center">3</td>
			<td>УЗИ мочевыделительной системы: почки, мочевой пузырь, мочеточники</td>
			<td align="center">800,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
		<tr>
			<td align="center">4</td>
			<td>Комплексное исследование брюшной полости и почек (печень, ПЖЖ, селезенка, желчный пузырь, почки)</td>
			<td align="center">1100,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
		<tr>
			<td align="center">5</td>
			<td>УЗИ лимфатических узлов (1 группа)</td>
		...
		<tr>
			...
			<td>УЗИ слюнной железы (1 зона)</td>
			<td align="center">700,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
		<tr>
			<td align="center">8</td>
			<td>УЗИ щитовидной железы</td>
			<td align="center">600,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align="center">1000,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
		<tr>
			<td align="center">11</td>
			<td>УЗИ малого таза (трансабдоминально)</td>
			<td align="center">700,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
		<tr>
			<td align="center">12</td>
			<td>УЗИ малого таза комплексное (вагинально и трансабдоминально)</td>
			<td align="center">1100,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
		<tr>
			<td align="center">13</td>
			<td>УЗИ малого таза комплексное (вагинально; virgo-ректально)</td>
			<td align="center">1500,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>УЗИ предстательной железы (трансабдоминально)</td>
			<td align="center">800,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
		<tr>
			<td align="center">16</td>
			<td>УЗИ предстательной железы 2 доступа (абдоминальный и ректальный)</td>
			<td align="center">1100,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>УЗИ сустава (наличие жидкости)</td>
			<td align="center">500,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
		<tr>
			<td align="center">21</td>
			<td>Комплексное УЗИ – обследование для женщин (Брюшная полость, мочевыделительная система, молочные железы, малый таз (2 доступа), щитовидная железа)</td>
			<td align="center">3000,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
		<tr>
			<td align="center">22</td>
			<td>Комплексное УЗИ - обследование для мужчин (Брюшная полость, мочевыделительная система, предстательная железа (2 доступа), щитовидная железа)</td>
			<td align="center">2700,00 руб.</td>
			<td align="center">звоните</td>
		</tr>
	</tbody>
</table>
...
<title>MODX Revolution - Цены</title>
...
<div class="page-container">
	...
	<a title="Цены" href="prices/" class="first active">Цены</a>
...
<li>
 ...
 <i class="fa fa-long-arrow-right"></i> <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Цены</li></li>
</ul>
                </div>
...
[[!isChild:is=`1`:then=`<h2>Платные услуги узи</h2>
...
<li>
    ...
    '[[$?text=`Цены`]]' => '<li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Цены</li>',
    ...
    '[[$?text=`<li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Цены</li>`]]' => '<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Цены</li></li>',
...
`]]' => '<ul class="B_crumbBox"><li class="B_firstCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_homeCrumb" itemprop="url" rel="Home" href="http://mcmpspb.yellowmarker.ru/"><span itemprop="title"><i class="fa fa-home"></i></span></a></li>
 ...
 <i class="fa fa-long-arrow-right"></i> <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Цены</li></li>
    ...
    '[[*parent:is=`3`:or:is=`0`:then=`<h2>Платные услуги узи</h2>
