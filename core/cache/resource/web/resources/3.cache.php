...
<title>MODX Revolution - Новости</title>
...
<li>
	<a title="Новости" href="about/novosti/" class="active">Новости</a>
...
<li>
 ...
 <i class="fa fa-long-arrow-right"></i> <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Новости</li></li>
</ul>
                </div>
                ...
                <div class="news-list-items-block">
    [[!getPage@standart_ru? 
...
<li>
    ...
    '[[$?text=`Новости`]]' => '<li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Новости</li>',
    ...
    '[[$?text=`<li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Новости</li>`]]' => '<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Новости</li></li>',
...
</div>`]]' => '<div class="news-list-items-block">
    [[!getPage@standart_ru? 
        &elementClass=`modSnippet` 
        &element=`getResources` 
        &parents=`3` 
...
<div class="row articles">
    ...
    '[[$outputManager]]' => '<div class="news-list-items-block">
    [[!getPage@standart_ru? 
        &elementClass=`modSnippet` 
        &element=`getResources` 
        &parents=`3` 
...
[[!isChild:is=`1`:then=``? &parent=`163`]]',
    ...
    '[[~7]]' => 'about/novosti/vetryanoj-ospoj-i-kishechnyimi-infekcziyami-v-peterburge-vse-chashhe/',
    '[[~8]]' => 'about/novosti/pervaya-nauchno-prakticheskaya-konferencziya-«prostuda-i-gripp»/',
    '[[~9]]' => 'about/novosti/poddelnyie-medknizhki-stanovyatsya-nastoyashhej-ugrozoj-zdorovyu-rossiyan/',
    '[[~10]]' => 'about/novosti/v-lenoblasti-20-chelovek-zaboleli-kleshhevyim-enczefalitom/',
    '[[~11]]' => 'about/novosti/kleshhi-prodolzhayut-zarazhat-enczefalitom-zhitelej-zapadnyix-oblastej/',
    '[[~12]]' => 'about/novosti/epidemicheskuyu-vakczinacziyu-v-sankt-peterburge-proshli-80-detej/',
    '[[~13]]' => 'about/novosti/epidemiya-grippa-i-podgotovka-sankt-peterburga-k-sezonnoj-vspyishke-prostudnyix-zabolevanij/',
    '[[~14]]' => 'about/novosti/epidemicheskij-porog-grippa-v-moskve-prevyishen-na-3-proczenta/',
    '[[~15]]' => 'about/novosti/rezultatyi-oprosa-«nuzhna-li-privivka-protiv-grippa»/',
    '[[~16]]' => 'about/novosti/rospotrebnadzor-nastaivaet-na-neobxodimosti-vakczinaczii-detej-i-vzroslyix/',
    '[[$?namespace=``&limit=`10`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`3`&depth=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&includeContent=`1`&tpl=`newsListTpl`&total=`63`&pageOneLimit=`10`&actualLimit=`10`&toPlaceholder=``&qs=`650d97a0720961d8e01fc5a94275c4b9`&pageCount=`7`&href=`about/novosti/`&pageNo=`1`]]' => '<li[[+activeClasses]]><a class="active"[[+title]] href="about/novosti/">1</a></li>',
    '[[$?namespace=``&limit=`10`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`3`&depth=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&includeContent=`1`&tpl=`newsListTpl`&total=`63`&pageOneLimit=`10`&actualLimit=`10`&toPlaceholder=``&qs=`df001d4f9885d4a2225213ad2cbc1aac`&pageCount=`7`&href=`about/novosti/?page=2`&pageNo=`2`]]' => '<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=2">2</a></li>',
    '[[$?namespace=``&limit=`10`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`3`&depth=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&includeContent=`1`&tpl=`newsListTpl`&total=`63`&pageOneLimit=`10`&actualLimit=`10`&toPlaceholder=``&qs=`b756c38d9468f53123e99068c08c57c1`&pageCount=`7`&href=`about/novosti/?page=3`&pageNo=`3`]]' => '<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=3">3</a></li>',
    '[[$?namespace=``&limit=`10`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`3`&depth=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&includeContent=`1`&tpl=`newsListTpl`&total=`63`&pageOneLimit=`10`&actualLimit=`10`&toPlaceholder=``&qs=`4d0e2fb2dc3ff631319d33e4ae6fc7c7`&pageCount=`7`&href=`about/novosti/?page=4`&pageNo=`4`]]' => '<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=4">4</a></li>',
    '[[$?namespace=``&limit=`10`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`3`&depth=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&includeContent=`1`&tpl=`newsListTpl`&total=`63`&pageOneLimit=`10`&actualLimit=`10`&toPlaceholder=``&qs=`c4a31a07e3b114f3c728375f523ffb3b`&pageCount=`7`&href=`about/novosti/?page=5`&pageNo=`5`]]' => '<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=5">5</a></li>',
    '[[$?namespace=``&limit=`10`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`3`&depth=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&includeContent=`1`&tpl=`newsListTpl`&total=`63`&pageOneLimit=`10`&actualLimit=`10`&toPlaceholder=``&qs=`96652bc3b37043e7d502c08a6ca80fed`&pageCount=`7`&href=`about/novosti/?page=6`&pageNo=`6`]]' => '<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=6">6</a></li>',
    '[[$?namespace=``&limit=`10`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`3`&depth=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&includeContent=`1`&tpl=`newsListTpl`&total=`63`&pageOneLimit=`10`&actualLimit=`10`&toPlaceholder=``&qs=`59c130c20b30db048864f325a577b224`&pageCount=`7`&href=`about/novosti/?page=2`&pageNo=`2`]]' => '<li class="control"><a[[+classes]][[+title]] href="about/novosti/?page=2">&gt;</a></li>',
    '[[$?namespace=``&limit=`10`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`3`&depth=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&includeContent=`1`&tpl=`newsListTpl`&total=`63`&pageOneLimit=`10`&actualLimit=`10`&toPlaceholder=``&qs=`3551f6632cfe60fc845a1fad2858067c`&pageCount=`7`&href=`about/novosti/?page=7`&pageNo=`7`]]' => '<li class="control"><a[[+classes]][[+title]] href="about/novosti/?page=7">&gt;&gt;</a></li>',
    '[[$?namespace=``&limit=`10`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`3`&depth=`1`&includeTVs=`1`&processTVs=`1`&tvPrefix=``&includeContent=`1`&tpl=`newsListTpl`&total=`63`&pageOneLimit=`10`&actualLimit=`10`&toPlaceholder=``&qs=`003281dd9801028b16486cc145bfed97`&pageCount=`7`&pages=`<li[[+activeClasses]]><a class="active"[[+title]] href="about/novosti/">1</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=2">2</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=3">3</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=4">4</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=5">5</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=6">6</a></li>`&next=`<li class="control"><a[[+classes]][[+title]] href="about/novosti/?page=2">&gt;</a></li>`&last=`<li class="control"><a[[+classes]][[+title]] href="about/novosti/?page=7">&gt;&gt;</a></li>`]]' => '[[+first]][[+prev]]<li[[+activeClasses]]><a class="active"[[+title]] href="about/novosti/">1</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=2">2</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=3">3</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=4">4</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=5">5</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="about/novosti/?page=6">6</a></li><li class="control"><a[[+classes]][[+title]] href="about/novosti/?page=2">&gt;</a></li><li class="control"><a[[+classes]][[+title]] href="about/novosti/?page=7">&gt;&gt;</a></li>',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
