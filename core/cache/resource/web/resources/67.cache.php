...
<title>MODX Revolution - Статьи</title>
...
<li>
	<a title="Статьи" href="articles/" class="active">Статьи</a>
	
</li>
<li>
	<a title="Справочник заболеваний" href="spravochnik-zabolevaniy/" class="">Справочник заболеваний</a>
...
<li>
 ...
 <i class="fa fa-long-arrow-right"></i> <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Статьи</li></li>
</ul>
                </div>
...
<div class="col-sm-3 side-menu-block">
    <h4>Категории</h4>
[[!Wayfinder?
    &startId=`67`
    &level=`1`
...
<li>
    ...
    '[[$?text=`Статьи`]]' => '<li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Статьи</li>',
    ...
    '[[$?text=`<li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Статьи</li>`]]' => '<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Статьи</li></li>',
...
[[!isChild:is=`1`:then=``? &parent=`163`]]',
    ...
    '[[~69]]' => 'articles/allergiya-i-astma/allergicheskie-reaktsii-tipy-simptomy-i-lechenie/',
    '[[~68]]' => 'articles/allergiya-i-astma/',
    '[[~70]]' => 'articles/allergiya-i-astma/terapiya-probiotikami-pomogaet-rostu-kishechnykh-bakteriy-klostridii-clostridia-zashchishchayushchikh/',
    '[[~71]]' => 'articles/allergiya-i-astma/upotreblenie-fastfuda-svyazano-s-astmoy-i-ekzemoy-u-detey/',
    '[[~74]]' => 'articles/dermatologiya/dieta-pri-akne-pitanie-pri-ugrevoy-sypi/',
    '[[~72]]' => 'articles/dermatologiya/',
    '[[~75]]' => 'articles/dermatologiya/osnovnye-zabolevaniya-kozhi/',
    '[[~76]]' => 'articles/dermatologiya/ploskiy-lishay-simptomy-prichiny-lechenie/',
    '[[~78]]' => 'articles/dermatologiya/psoriaz-i-ego-lechenie/',
    '[[~80]]' => 'articles/ginekologiya/endometrioz-odno-iz-samykh-rasprostranennykh-ginekologicheskikh-zabolevaniy/',
    '[[~79]]' => 'articles/ginekologiya/',
    '[[~81]]' => 'articles/ginekologiya/fibromioma-matki-diagnostika-i-lechenie/',
    '[[~82]]' => 'articles/ginekologiya/metabolicheskie-narusheniya-pri-beremennosti/',
    '[[~83]]' => 'articles/ginekologiya/mify-i-pravda-o-tsistite/',
    '[[~84]]' => 'articles/ginekologiya/mioma-eto-ne-prigovor/',
    '[[~85]]' => 'articles/ginekologiya/preimushchestvo-prizhiganiya-erozii-sheyki-matki-lazerom-i-argonom/',
    '[[~86]]' => 'articles/ginekologiya/vidy-abortov-i-ikh-osobennosti/',
    '[[~89]]' => 'articles/kardiologiya/lechenie-serdechnoy-nedostatochnosti-sovremennye-lekarstvennye-sredstva/',
    '[[~88]]' => 'articles/kardiologiya/',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`67`&depth=`3`&includeContent=`1`&tpl=`articlesListTpl`&total=`75`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`c896baa57d7e787ebed40edc0e893f80`&pageCount=`5`&href=`articles/`&pageNo=`1`]]' => '<li[[+activeClasses]]><a class="active"[[+title]] href="articles/">1</a></li>',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`67`&depth=`3`&includeContent=`1`&tpl=`articlesListTpl`&total=`75`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`d371326779dc8d5146a2d774b38aa727`&pageCount=`5`&href=`articles/?page=2`&pageNo=`2`]]' => '<li[[+classes]]><a[[+classes]][[+title]] href="articles/?page=2">2</a></li>',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`67`&depth=`3`&includeContent=`1`&tpl=`articlesListTpl`&total=`75`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`cd837f8024e8dea635f996c98df65e4d`&pageCount=`5`&href=`articles/?page=3`&pageNo=`3`]]' => '<li[[+classes]]><a[[+classes]][[+title]] href="articles/?page=3">3</a></li>',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`67`&depth=`3`&includeContent=`1`&tpl=`articlesListTpl`&total=`75`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`3623a870003734ca532c97de85bddd96`&pageCount=`5`&href=`articles/?page=4`&pageNo=`4`]]' => '<li[[+classes]]><a[[+classes]][[+title]] href="articles/?page=4">4</a></li>',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`67`&depth=`3`&includeContent=`1`&tpl=`articlesListTpl`&total=`75`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`2bbeb22232e30470efdc7f0d33fce1b8`&pageCount=`5`&href=`articles/?page=5`&pageNo=`5`]]' => '<li[[+classes]]><a[[+classes]][[+title]] href="articles/?page=5">5</a></li>',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`67`&depth=`3`&includeContent=`1`&tpl=`articlesListTpl`&total=`75`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`5952c474f5f213ac7365fa3f6fff67ca`&pageCount=`5`&href=`articles/?page=2`&pageNo=`2`]]' => '<li class="control"><a[[+classes]][[+title]] href="articles/?page=2">&gt;</a></li>',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`67`&depth=`3`&includeContent=`1`&tpl=`articlesListTpl`&total=`75`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`dbee125d1a386c925ab8ad39d6c065fa`&pageCount=`5`&href=`articles/?page=5`&pageNo=`5`]]' => '<li class="control"><a[[+classes]][[+title]] href="articles/?page=5">&gt;&gt;</a></li>',
    '[[$?namespace=``&limit=`15`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`total`&pageLimit=`5`&elementClass=`modSnippet`&pageNavVar=`page.nav`&pageNavTpl=`<li[[+classes]]><a[[+classes]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageNavOuterTpl=`[[+first]][[+prev]][[+pages]][[+next]][[+last]]`&pageActiveTpl=`<li[[+activeClasses]]><a[[+activeClasses:default=` class="active"`]][[+title]] href="[[+href]]">[[+pageNo]]</a></li>`&pageFirstTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;&lt;</a></li>`&pageLastTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;&gt;</a></li>`&pagePrevTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&lt;</a></li>`&pageNextTpl=`<li class="control"><a[[+classes]][[+title]] href="[[+href]]">&gt;</a></li>`&cache=``&cache_key=`resource`&cache_handler=`xPDOFileCache`&cache_expires=`0`&pageNavScheme=``&element=`getResources`&parents=`67`&depth=`3`&includeContent=`1`&tpl=`articlesListTpl`&total=`75`&pageOneLimit=`15`&actualLimit=`15`&toPlaceholder=``&qs=`361dba30fc0aff39584dd183fe8af42c`&pageCount=`5`&pages=`<li[[+activeClasses]]><a class="active"[[+title]] href="articles/">1</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="articles/?page=2">2</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="articles/?page=3">3</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="articles/?page=4">4</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="articles/?page=5">5</a></li>`&next=`<li class="control"><a[[+classes]][[+title]] href="articles/?page=2">&gt;</a></li>`&last=`<li class="control"><a[[+classes]][[+title]] href="articles/?page=5">&gt;&gt;</a></li>`]]' => '[[+first]][[+prev]]<li[[+activeClasses]]><a class="active"[[+title]] href="articles/">1</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="articles/?page=2">2</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="articles/?page=3">3</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="articles/?page=4">4</a></li>
<li[[+classes]]><a[[+classes]][[+title]] href="articles/?page=5">5</a></li><li class="control"><a[[+classes]][[+title]] href="articles/?page=2">&gt;</a></li><li class="control"><a[[+classes]][[+title]] href="articles/?page=5">&gt;&gt;</a></li>',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
